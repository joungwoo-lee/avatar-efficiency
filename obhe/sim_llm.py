...
class SimLLM:
    def complete_json(self, prompt, max_tokens=4000):
        ...
        if charts:
            reference.insert(6, {
                "outcome": "최종 문서", "action": "make_chart", "quantity": charts,
