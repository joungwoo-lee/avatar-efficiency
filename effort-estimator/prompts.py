...
9. 필수 QA는 별도 Work Item으로 표현한다. 임의의 QA 배수를 적용하지 않는다.
...
내부 처리 단계:
1. 지침서에서 독립 수용 가능한 결과 단위로 Requirement를 복원한다(결과 중심 제목).
2. 복합 결과를 독립 Requirement로 분리한다.
